...
在 iPhone 上直接安装：[WLOC设置位置](https://www.icloud.com/shortcuts/b6dfc95abf344ba9bd4f98f8ad8f68f6)（[二维码](../shortcuts/WLOC设置位置-二维码.png)）、[WLOC恢复定位](https://www.icloud.com/shortcuts/fddd99ba529b457088243640b28ded6a)（[二维码](../shortcuts/WLOC恢复定位-二维码.png)）。
