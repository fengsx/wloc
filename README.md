...
| 客户端 | 订阅地址 |
| --- | --- |
| Surge / Egern | [https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.sgmodule](https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.sgmodule) |
| Quantumult X | [https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.conf](https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.conf) |
| Loon | [https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.lpx](https://raw.githubusercontent.com/fengsx/wloc/refs/heads/main/modules/wloc.lpx) |
...
已核对两个 iCloud 分享文件：设置位置指令保留地图链接 URL 编码变量，使用本仓库的 `/api/parse?format=json`，再调用手机模块的保存路径；恢复定位指令调用 `?action=clear`。iPhone 13 mini／iOS 26.5 上的实际定位效果仍需真机验证。
